...
public static class AnEngine
{
  ...
  public static readonly QualificationEngineIdentity Reasoning = new("llm", "qwen3:8b");

  /// <summary>L'identité déclarée par le moteur qui tient le rôle de témoin.</summary>
  public static readonly QualificationEngineIdentity Lexical = new("lexicon", "1.0.0");
}
