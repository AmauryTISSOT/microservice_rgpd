...
/// <c>Aucune modification vers le Manifest</c> bannit nommément est exactement cette forme — il
/// rapprocherait les colonnes retenues de ce qui est déjà déclaré pour pré-remplir le
/// <c>Manifest</c>.
/// </para>
/// <para>
