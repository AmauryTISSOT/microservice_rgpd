...
Le guide du poste de développement : lancer la pile, activer les moteurs, passer les tests. La
présentation du projet et son lien avec le mémoire sont dans le [README](README.md).

Le projet a été généré depuis [ardalis/CleanArchitecture](https://github.com/ardalis/CleanArchitecture) v11.1.1 (variante `clean-arch`).

## La qualification : contrat et moteurs
