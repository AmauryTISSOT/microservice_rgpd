...
WITH demandes (n, origine, ancrage, jours, nom, prenom, email, identite_verifiee, droit, statut,
  ...
  (1, 'Email', 'echeance', -13, NULL, NULL, 'client.fidele1@example.com', false, 'Rectification', 'InProgress', 0, '14:20', 'Vous avez encore mon ancien mail. Le bon c''est prenom.nom@exemple.invalid, changez-le s''il vous plaît.'),
  (2, 'Email', 'recue', 70, 'Vasseur', 'Agnès', 'agnes.vasseur@example.com', true, 'Access', 'Completed', 0, '09:12', 'Je voudrais connaître le score que votre algorithme m''a attribué et sur quelles données il s''appuie.'),
  ...
  (4, 'Email', 'recue', 19, 'Charpentier', 'Olivier', 'olivier.charpentier@example.com', false, 'Access', 'InProgress', 1, '17:05', 'Madame, Monsieur,
...
Olivier Charpentier'),
  (5, 'Email', 'recue', 33, 'Benali', 'Karim', 'karim.benali@example.com', false, 'Portability', 'Cancelled', 1, '16:12', 'Je change d''opérateur. Pouvez-vous m''envoyer mes données dans un fichier que je puisse réimporter chez eux ?'),
  ...
  (7, 'Email', 'recue', 4, NULL, NULL, 'jardin.secret7@example.com', false, 'Erasure', 'InProgress', 0, '14:05', 'Retirez-moi de vos fichiers, je ne veux plus rien avoir à faire avec vous.'),
  (8, 'Letter', 'recue', 78, 'Barbier', 'Léa', 'lea.barbier@example.com', true, 'Portability', 'Completed', 2, '14:34', 'Madame, Monsieur,
...
Léa Barbier'),
  ...
  (10, 'Email', 'echeance', -60, NULL, NULL, 'marcheur.du.dimanche10@example.com', true, 'Access', 'InProgress', 1, '17:47', 'bonjour je veut voire mon dossier chez vous et tout ce que vous savez de moi merci davance'),
  (11, 'Letter', 'recue', 6, 'Lefèvre', 'Élodie', 'elodie.lefevre@example.com', true, 'Access', 'InProgress', 3, '16:20', 'Madame, Monsieur,
...
Élodie Lefèvre'),
  ...
  (13, 'Letter', 'recue', 16, 'Roger', 'Gabriel', 'gabriel.roger@example.com', true, 'Erasure', 'InProgress', 2, '08:05', 'Madame, Monsieur,
...
Cordialement,
Gabriel Roger'),
  (14, 'Email', 'recue', 112, 'Martin', 'Jean', 'jean.martin@example.com', false, 'Access', 'Completed', 0, '14:12', 'Qui a eu accès à mes données ces douze derniers mois ? Merci de me communiquer la liste des destinataires.'),
...
Victor Noël'),
  ...
  (19, 'Email', 'recue', 170, 'Bonnet', 'Hugo', 'hugo.bonnet@example.com', false, 'Erasure', 'Cancelled', 0, '11:05', 'Je retire le consentement que j''avais donné au traitement de mes données à des fins d''analyse comportementale. Par conséquent, je vous demande de les effacer.'),
  (20, 'Email', 'recue', 16, 'Bernard', 'Camille', 'camille.bernard@example.com', true, 'Rectification', 'InProgress', 0, '09:12', 'Conformément à l''article 16 du règlement (UE) 2016/679, je vous demande de rectifier mon adresse postale, erronée dans vos fichiers. L''adresse exacte est le 4 rue des Lilas, 69003 Lyon.'),
...
Cordialement,
Françoise Leclerc'),
  (22, 'Email', 'recue', 38, 'D''Aboville', 'Nathalie', 'nathalie.daboville@example.com', true, 'Access', 'Completed', 0, '13:34', 'Je souhaite exercer mon droit d''accès. Merci de m''indiquer l''origine des informations que vous détenez sur moi et la durée de conservation prévue.'),
  (23, 'Letter', 'recue', 5, 'Nguyen', 'Van Anh', 'vananh.nguyen@example.com', false, 'Erasure', 'InProgress', 2, '12:12', 'Madame, Monsieur,
...
Jade Picard'),
  ...
  (28, 'Email', 'recue', 57, 'Arnaud', 'Patrick', 'patrick.arnaud@example.com', true, 'Objection', 'Completed', 0, '16:12', 'Je m''oppose à l''utilisation de mes données à des fins de recherche statistique, en application de l''article 21.6.'),
  (29, 'Email', 'recue', 3, NULL, NULL, 'bibi.du.6929@example.com', false, 'Access', 'InProgress', 0, '14:00', 'Madame, Monsieur, conformément à l''article 15 du règlement (UE) 2016/679, je vous demande de me communiquer une copie de l''ensemble des données à caractère personnel me concernant que vous traitez, ainsi que les finalités de ce traitement et les destinataires de ces données. Je vous prie d''agréer mes salutations distinguées.'),
  ...
  (31, 'Letter', 'recue', 1, 'Poirier', 'Sylvie', 'sylvie.poirier@example.com', true, 'Erasure', 'InProgress', 2, '10:58', 'Madame, Monsieur,

Merci de supprimer la photo de profil associée à mon compte, je souhaite qu''elle ne figure plus sur votre plateforme.

Cordialement,
Sylvie Poirier'),
  (32, 'Email', 'echeance', 6, 'Colin', 'Laura', 'laura.colin@example.com', true, 'Access', 'InProgress', 0, '12:47', 'Pourriez-vous m''expliquer pourquoi vous conservez mon numéro de téléphone et sur quelle base légale ?'),
  ...
  (34, 'Email', 'recue', 0, 'Garnier', 'François', 'francois.garnier@example.com', false, 'Erasure', 'InProgress', 0, '09:12', 'En application de l''article 17 du règlement (UE) 2016/679, je vous demande de procéder à l''effacement de l''ensemble des données à caractère personnel me concernant, ainsi qu''à leur suppression chez vos éventuels sous-traitants.'),
...
Jérôme Bézier'),
  ...
  (37, 'Letter', 'recue', 1, 'Masson', 'Alice', 'alice.masson@example.com', true, 'Objection', 'InProgress', 1, '09:58', 'Madame, Monsieur,

Arrêtez de me démarcher, j''en ai assez de vos appels.

Cordialement,
Alice Masson'),
  (38, 'Email', 'recue', 14, 'Morin', 'Christelle', 'christelle.morin@example.com', false, 'Erasure', 'InProgress', 1, '09:12', 'Vous conservez mes données depuis huit ans alors que je ne suis plus client depuis 2019. Merci de les supprimer, elles ne sont plus nécessaires au regard des finalités pour lesquelles vous les aviez collectées.'),
...
Cordialement,
Fatou Diallo'),
  (40, 'Email', 'recue', 4, 'Rivière', 'Pauline', 'pauline.riviere@example.com', false, 'Rectification', 'InProgress', 0, '13:05', 'Ma date de naissance est fausse dans mon espace client : vous avez 1987 au lieu de 1978.'),
  (41, 'Email', 'recue', 10, NULL, NULL, 'k.dev41@example.com', true, 'Objection', 'InProgress', 0, '11:58', 'Ne m''envoyez plus de publicité, ni par courriel ni par SMS. Vous pouvez conserver mon compte client, je continue à utiliser vos services.'),
...
Cordialement,
Chloé Mercier'),
  (44, 'Email', 'recue', 19, 'Boyer', 'Josée', 'josee.boyer@example.com', false, 'Access', 'InProgress', 0, '12:47', 'Bonjour, j''aimerais savoir quelles informations vous avez sur moi. Pouvez-vous m''en envoyer la liste ?'),
  ...
  (46, 'Email', 'recue', 14, NULL, NULL, 'chat.noir46@example.com', true, 'Restriction', 'InProgress', 0, '16:05', 'Le traitement me paraît illicite, mais je m''oppose à l''effacement de mes données : j''en ai besoin. Je demande donc leur limitation.'),
  (47, 'Email', 'echeance', 7, 'Aubert', 'Thérèse', 'therese.aubert@example.com', true, 'Erasure', 'InProgress', 0, '10:20', 'Je retire le consentement que j''avais donné au traitement de mes données à des fins d''analyse comportementale. Par conséquent, je vous demande de les effacer.'),
...
Cordialement,
Thomas Leroy'),
  (49, 'Email', 'recue', 13, 'Blanchard', 'Zoé', 'zoe.blanchard@example.com', false, 'Restriction', 'InProgress', 1, '13:47', 'J''ai besoin de ces éléments comme preuve pour mon dossier aux prud''hommes, ne les effacez pas mais cessez de les exploiter.'),
  (50, 'Letter', 'recue', 5, 'Da Silva', 'Arthur', 'arthur.dasilva@example.com', true, 'Erasure', 'InProgress', 2, '11:34', 'Madame, Monsieur,
...
Cordialement,
Loïc Brémond'),
  (53, 'Email', 'recue', 63, NULL, NULL, 'ex.abonne53@example.com', false, 'Rectification', 'Completed', 0, '10:20', 'Vous écrivez mon nom « Duran » alors que c''est « Durand », avec un D final. Merci de corriger.'),
  ...
  (55, 'Email', 'echeance', -20, NULL, NULL, 'petitpois55@example.com', false, 'Objection', 'InProgress', 1, '12:20', 'Je ne souhaite plus que mes achats servent à me proposer des recommandations personnalisées.'),
...
Inès Fontaine'),
  ...
  (58, 'Email', 'recue', 7, 'Collet', 'Rémi', 'remi.collet@example.com', false, 'Objection', 'InProgress', 1, '09:34', 'Conformément à l''article 21.2 du règlement (UE) 2016/679, je m''oppose au traitement de mes données à caractère personnel à des fins de prospection commerciale.'),
  (59, 'Email', 'echeance', 5, NULL, NULL, 'pseudo.anonyme59@example.com', false, 'Erasure', 'InProgress', 0, '12:34', 'Je souhaite supprimer mon compte et que vous effaciez toutes les données qui y sont rattachées.'),
  ...
  (61, 'Email', 'echeance', -2, NULL, NULL, 'contact.perso61@example.com', true, 'Access', 'InProgress', 1, '15:41', 'Salut, vous avez quoi comme infos sur moi dans vos fichiers ? J''aimerais bien voir ce que vous stockez.'),
  (62, 'Letter', 'recue', 11, 'Lambert', 'Manon', 'manon.lambert@example.com', true, 'Restriction', 'InProgress', 1, '16:58', 'Madame, Monsieur,
...
Manon Lambert'),
  ...
  (64, 'Email', 'recue', 10, 'Le Goff', 'Maël', 'mael.legoff@example.com', false, 'Restriction', 'InProgress', 0, '15:20', 'Je conteste le montant d''impayé que vous m''attribuez. Tant que ce n''est pas vérifié, merci de ne pas transmettre ces données à des tiers, sans pour autant les effacer.'),
  (65, 'Letter', 'echeance', 4, 'Dumas', 'Maxime', 'maxime.dumas@example.com', false, 'Restriction', 'InProgress', 2, '14:47', 'Madame, Monsieur,
...
Maxime Dumas'),
  ...
  (67, 'Email', 'recue', 7, 'Lopez', 'Clara', 'clara.lopez@example.com', true, 'Rectification', 'InProgress', 1, '10:58', 'Mon statut marital indiqué chez vous n''est plus exact, je suis divorcé depuis 2024.'),
...
Hélène Dupré'),
  ...
  (70, 'Email', 'recue', 124, 'Fournier', 'Lucas', 'lucas.fournier@example.com', false, 'Restriction', 'Completed', 1, '09:05', 'Merci de geler l''utilisation de mon dossier en attendant le résultat de ma réclamation.'),
  (71, 'Email', 'recue', 47, 'Vidal', 'Adèle', 'adele.vidal@example.com', true, 'Erasure', 'Cancelled', 0, '13:12', 'Merci de supprimer la photo de profil associée à mon compte, je souhaite qu''elle ne figure plus sur votre plateforme.'),
  ...
  (73, 'Email', 'recue', 93, NULL, NULL, 'cuisine.maison73@example.com', true, 'Objection', 'Completed', 1, '13:05', 'Cessez d''utiliser mon adresse pour vos campagnes marketing ; je reste par ailleurs client chez vous.'),
  (74, 'Email', 'recue', 18, NULL, NULL, 'plume.bleue74@example.com', false, 'Rectification', 'InProgress', 0, '17:20', 'J''ai déménagé le mois dernier, merci de mettre à jour mon adresse : 12 avenue Victor Hugo, 33000 Bordeaux.'),
  (75, 'Letter', 'recue', 11, 'Durand', 'Sophie', 'sophie.durand@example.com', true, 'Access', 'InProgress', 1, '17:12', 'Madame, Monsieur, conformément à l''article 15 du règlement (UE) 2016/679, je vous demande de me communiquer une copie de l''ensemble des données à caractère personnel me concernant que vous traitez, ainsi que les finalités de ce traitement et les destinataires de ces données. Je vous prie d''agréer mes salutations distinguées.'),
  (76, 'Email', 'recue', 85, 'Henry', 'Antoine', 'antoine.henry@example.com', false, 'Erasure', 'Completed', 1, '10:34', 'En application de l''article 17 du règlement (UE) 2016/679, je vous demande de procéder à l''effacement de l''ensemble des données à caractère personnel me concernant, ainsi qu''à leur suppression chez vos éventuels sous-traitants.'),
  (77, 'Letter', 'recue', 22, 'Lacroix', 'Anne-Sophie', 'anne-sophie.lacroix@example.com', false, 'Portability', 'Completed', 3, '14:12', 'Madame, Monsieur,
...
Anne-Sophie Lacroix'),
  ...
  (79, 'Email', 'recue', 7, 'Petit', 'Nicolas', 'nicolas.petit@example.com', true, 'Restriction', 'InProgress', 1, '11:47', 'Ne vous servez plus de mes données pour l''instant, mais ne les supprimez pas : j''en aurai besoin.'),
  (80, 'Email', 'recue', 26, 'Lemaître', 'Benoît', 'benoit.lemaitre@example.com', true, 'Erasure', 'Completed', 1, '16:12', 'Retirez-moi de vos fichiers, je ne veux plus rien avoir à faire avec vous.'),
...
Cordialement,
Solène Prévost'),
  (83, 'Letter', 'echeance', -110, 'Faure', 'Noémie', 'noemie.faure@example.com', false, 'Rectification', 'InProgress', 1, '09:34', 'Madame, Monsieur,
...
Cordialement,
Aurélien Perrot'),
  (86, 'Email', 'recue', 12, 'Roux', 'Julie', 'julie.roux@example.com', false, 'Erasure', 'InProgress', 1, '16:00', 'Vous conservez mes données depuis huit ans alors que je ne suis plus client depuis 2019. Merci de les supprimer, elles ne sont plus nécessaires au regard des finalités pour lesquelles vous les aviez collectées.'),
  ...
  (88, 'Letter', 'echeance', -35, 'Marchand', 'Paul', 'paul.marchand@example.com', false, 'Access', 'InProgress', 2, '14:47', 'Madame, Monsieur,

Bonjour, j''aimerais savoir quelles informations vous avez sur moi. Pouvez-vous m''en envoyer la liste ?

Cordialement,
Paul Marchand'),
  (89, 'Email', 'recue', 9, 'Girard', 'Clément', 'clement.girard@example.com', false, 'Objection', 'InProgress', 0, '09:58', 'Je m''oppose à l''utilisation de mes données à des fins de recherche statistique, en application de l''article 21.6.'),
  ...
  (91, 'Letter', 'echeance', 6, 'Hamon', 'Cédric', 'cedric.hamon@example.com', true, 'Portability', 'InProgress', 2, '17:05', 'Madame, Monsieur,

bonjour je voudrai recuperer mes donné pour les mettre chez un autre site est ce possible en fichier exel

Cordialement,
Cédric Hamon'),
  (92, 'Email', 'recue', 12, 'Rousseau', 'Célia', 'celia.rousseau@example.com', true, 'Access', 'Cancelled', 1, '17:05', 'Qui a eu accès à mes données ces douze derniers mois ? Merci de me communiquer la liste des destinataires.'),
  ...
  (94, 'Email', 'recue', 18, 'Besnard', 'Stéphane', 'stephane.besnard@example.com', false, 'Portability', 'InProgress', 0, '14:47', 'Je change d''opérateur. Pouvez-vous m''envoyer mes données dans un fichier que je puisse réimporter chez eux ?'),
  (95, 'Email', 'echeance', 5, NULL, NULL, 'lolo.4495@example.com', false, 'Access', 'InProgress', 1, '13:47', 'Salut, vous avez quoi comme infos sur moi dans vos fichiers ? J''aimerais bien voir ce que vous stockez.'),
  ...
  (97, 'Email', 'echeance', -1, 'Chevalier', 'Gaëlle', 'gaelle.chevalier@example.com', true, 'Erasure', 'InProgress', 0, '13:47', 'Je retire le consentement que j''avais donné au traitement de mes données à des fins d''analyse comportementale. Par conséquent, je vous demande de les effacer.'),
  (98, 'Email', 'recue', 152, 'Lucas', 'Margaux', 'margaux.lucas@example.com', true, 'Rectification', 'Completed', 1, '16:47', 'Ma date de naissance est fausse dans mon espace client : vous avez 1987 au lieu de 1978.'),
  ...
  (100, 'Email', 'recue', 3, NULL, NULL, 'lecteur.curieux100@example.com', true, 'Erasure', 'InProgress', 0, '09:05', 'Je ne veux plus apparaître nulle part chez vous. Effacez tout.')
