...
autorise, puis **exécuter la demande** : le droit invoqué est remis au système hôte — appelé à son
adresse, ou publié sur son routage —, et la demande passe à Terminée quand le destinataire, ou le
broker pour lui, en accuse réception. Une demande porte une date limite de réponse et un statut ;
