...
/// </para>
/// <para>
/// ⚠️ <b>Elle est irréversible et sans trace.</b> Il n'y a pas de journal de preuve ici — le grain
/// est le déploiement — et rien ne consigne qu'un rapport a existé : après ce geste, le travail
