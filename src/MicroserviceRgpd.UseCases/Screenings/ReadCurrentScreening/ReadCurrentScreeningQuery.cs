...
/// <summary>
/// Relire le <b>sommaire</b> du rapport de détection courant.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// ⚠️ <b>Elle rend <c>null</c> quand le déploiement n'a lancé aucune détection</b>, et l'écran rend
/// alors le dépôt seul. Un rapport de détection vide portant « ce rapport de détection n'a pas
/// regardé le CRM en SaaS, les
...
/// rien n'est signalé », qui reste refusé : là il y a un rapport de détection réel dont on tairait
/// le seuil zéro, ici il n'y a pas de détection du tout.
/// </para>
/// <para>
