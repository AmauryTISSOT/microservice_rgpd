...
/// </para>
/// <para>
/// <b>Deux destinataires, deux grains.</b> Le <c>EvidenceLog</c> reçoit la tentative, datée, dans le
...
/// l'<b>appelant</b>, qui dit ce qu'il avait obtenu la fois d'avant : le <c>EvidenceLog</c>, lui, ne se
  ...
  TimeProvider clock)
{
  ...
  /// on ne l'avait jamais appelé. C'est ce que l'<b>appelant</b> sait et que le <c>EvidenceLog</c> ne
