...
namespace MicroserviceRgpd.Infrastructure.Migrations
{
    ...
    [Migration("20260910205826_CreateSettings")]
            ...
            modelBuilder.Entity("MicroserviceRgpd.Core.Casework.Case", b =>
                {
                    ...
                    b.Property<string>("ClosingCause")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("MicroserviceRgpd.Infrastructure.Data.Casework.EvidenceLogRow", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("InformedOn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("informed_on");
                    ...
                    b.OwnsOne("MicroserviceRgpd.Core.Casework.ExtensionDeclaration", "ExtensionDeclaration", b1 =>
                        {
                            ...
                            b1.Property<DateTimeOffset>("DeclaredOn")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("extension_declared_on");

                            b1.Property<DateTimeOffset>("InformedOn")
                                .HasColumnType("timestamp with time zone")
                                .HasColumnName("extension_informed_on");
