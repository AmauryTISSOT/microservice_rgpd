...
internal static class ChromeNavigation
{
  ...
  /// </summary>
  internal static bool IsCurrent(ChromeEntryPoint entryPoint, PathString path)
  {
    return path.StartsWithSegments(entryPoint.Address, StringComparison.OrdinalIgnoreCase);
  }
}
