...
/// dissocier finissent par se dissocier</b>.
/// </para>
/// <para>
/// ⚠️ <b>Personne n'est enregistré ici, et c'est une décision.</b> Ce contexte ne garde pas qui a
/// arbitré — voir l'<c>ADR-0014</c>. Un nom saisi sans authentification n'aurait été qu'une
...
/// l'écrase. Une histoire demanderait une troisième table, c'est-à-dire un journal de preuve, au
/// grain que ce contexte refuse — et un rapport de détection neuf détruit de toute façon
/// <i>tous</i> les arbitrages, si bien qu'une histoire fine à l'intérieur d'un rapport serait une précision
