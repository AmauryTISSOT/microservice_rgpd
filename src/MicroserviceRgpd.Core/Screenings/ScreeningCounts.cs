  ...
  int UnreadUnflagged)
{
  ...
  /// </summary>
  /// <remarks>
  /// ⚠️ <b>Un rapport chargé sans ses colonnes rendrait ici des zéros sincères et faux.</b> C'est
  /// pourquoi la lecture d'une table ne passe pas par ce chemin : elle ne charge jamais l'agrégat, et
  /// demande ses comptes à la base — voir <see cref="IScreenedColumns.CountsOfAsync"/>.
  /// </remarks>
