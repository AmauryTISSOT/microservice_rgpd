...
/// <summary>
/// Le nom de la personne qui exerce son droit. <b>Facultatif sur la demande</b> — l'absence s'y dit
/// par <c>null</c> —, mais jamais vide ici : un nom qui existe a au moins un caractère.
/// </summary>
...
public readonly partial struct LastName
{
  ...
  private static Validation Validate(string value)
  {
    if (value.Length == 0)
    {
      return Validation.Invalid("Un nom absent se dit par son absence, pas par un nom vide.");
    }

    return value.Length > MaxLength
      ? Validation.Invalid(DataSubjectRequestMessages.LastNameTooLong)
      : Validation.Ok;
  }
}
