...
/// ne nomme n'entre pas au <c>EvidenceLog</c> par une colonne de prose libre : il y entre par une valeur
/// que quelqu'un a décidé d'ajouter.
/// </para>
/// </remarks>
public sealed class EvidenceLogFact : SmartEnum<EvidenceLogFact>
{
  /// <summary>
  ...
  /// </summary>
  public static readonly EvidenceLogFact CaseOpened = new(nameof(CaseOpened), 0, "dossier ouvert");
  ...
  /// </summary>
  public static readonly EvidenceLogFact AdapterRefusedTheSecret =
  ...
  /// </summary>
  public static readonly EvidenceLogFact AdapterDidNotServeTheSystem =
  ...
  /// </summary>
  public static readonly EvidenceLogFact StepDeclared = new(nameof(StepDeclared), 3, "travail dû déclaré");
  ...
  /// </summary>
  public static readonly EvidenceLogFact ClaimConfirmed = new(nameof(ClaimConfirmed), 4, "droit confirmé");
  ...
  /// </summary>
  public static readonly EvidenceLogFact MotivationDeclared =
  ...
  /// <c>EvidenceLog</c> mesure l'ampleur d'une recherche, il ne dénombre pas les données de la personne.
  /// </summary>
  /// <remarks>
  ...
  /// </summary>
  public static readonly EvidenceLogFact LocateDeferred = new(nameof(LocateDeferred), 7, "localisation différée");
  ...
  /// écrire une valeur.
  /// </summary>
  public static readonly EvidenceLogFact ReservationAttached =
  ...
  /// </summary>
  public static readonly EvidenceLogFact ReservationSetAside =
  ...
  /// d'un humain.
  /// </summary>
  public static readonly EvidenceLogFact QuestionRaised = new(nameof(QuestionRaised), 10, "question posée");
  ...
  /// signataire.
  /// </remarks>
  public static readonly EvidenceLogFact ReadServed = new(nameof(ReadServed), 11, "lecture servie");
  ...
  /// </summary>
  public static readonly EvidenceLogFact ReadDeferred = new(nameof(ReadDeferred), 12, "lecture différée");
  ...
  /// <remarks>
  /// <para>
  /// ⚠️ <b>Ce dénombrement s'arrête ici et ne descend jamais dans la <c>DeliveryLetter</c>.</b> Son
  ...
  /// plus que la personne l'ait reçu — <c>Enregistré, jamais vérifié</c>.
  /// </para>
  /// </remarks>
  public static readonly EvidenceLogFact DeliveryDeclared =
  ...
  /// </remarks>
  public static readonly EvidenceLogFact ClaimAnswered = new(nameof(ClaimAnswered), 14, "droit répondu");
  ...
  /// </para>
  /// </remarks>
  public static readonly EvidenceLogFact CaseClosed = new(nameof(CaseClosed), 15, "dossier clos");
  ...
  /// </para>
  /// </remarks>
  public static readonly EvidenceLogFact ExtensionDeclared =
    new(nameof(ExtensionDeclared), 16, "prolongation déclarée");

  private EvidenceLogFact(string name, int value, string frenchLabel)
    : base(name, value)
  {
