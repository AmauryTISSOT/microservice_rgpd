...
/// qu'une hypothèse du service, et l'<c>EvidenceLog</c> garderait la même trace des deux. Le drapeau
...
public sealed record ReceptionDate
{
  ...
  /// « J+9 (défaut) » et ce que l'<c>EvidenceLog</c> consigne : le défaut doit être visible <b>comme un
