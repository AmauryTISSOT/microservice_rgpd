...
/// <remarks>
/// <para>
/// <b>Un nom n'est pas une authentification, et le <c>Ledger</c> le dit plutôt que de le taire.</b>
...
/// resteront lisibles pour ce qu'elles sont — sans quoi le <c>Ledger</c> d'aujourd'hui serait
/// indiscernable de celui de demain.
/// </para>
/// </remarks>
public sealed class SignatureRegime : SmartEnum<SignatureRegime>
{
  /// <summary>
  ...
  /// </summary>
  public static readonly SignatureRegime Unauthenticated =
    new(nameof(Unauthenticated), 0, "non authentifié");

  private SignatureRegime(string name, int value, string frenchLabel)
    : base(name, value)
  {
