...
/// <summary>
/// Les <c>Ledger</c> dont la conservation est <b>échue</b>, et leur destruction — <b>entière, et
/// jamais ligne à ligne</b>.
/// </summary>
/// <remarks>
/// <para>
/// <b>C'est un type à part d'<see cref="ILedger"/>, et c'est tout le propos.</b> L'ajout seul reste
...
/// </para>
/// <para>
/// ⚠️ <b>La destruction ne laisse aucune trace d'elle-même.</b> Un <c>Ledger</c> détruit ne peut pas
...
/// rouvrirait l'expurgation que la définition du <c>Ledger</c> ferme.
/// </para>
/// </remarks>
public interface IExpiredLedgers
{
  /// <summary>
  /// Les <c>Ledger</c> échus à cet instant : un dossier clos depuis plus de
  /// <see cref="LedgerRetention.Years"/> ans, dont la preuve est encore là.
  /// </summary>
  /// <remarks>
  /// <b>Un <c>Ledger</c> déjà détruit n'y figure plus</b>, son dossier clos eût-il survécu : la
  ...
  Task<IReadOnlyList<ExpiredLedger>> ListAsync(
    DateTimeOffset observedAt,
    CancellationToken cancellationToken = default);

  /// <summary>
  /// Détruit <b>en entier</b> le <c>Ledger</c> d'un dossier, si et seulement si sa conservation est
  /// échue à cet instant.
  /// </summary>
  /// <remarks>
...
/// <summary>
/// Un <c>Ledger</c> échu, tel que l'écran de la file le montre : un dossier, la date de sa clôture,
...
public sealed record ExpiredLedger(CaseId Case, DateTimeOffset ClosedOn, DateTimeOffset ExpiredOn);
