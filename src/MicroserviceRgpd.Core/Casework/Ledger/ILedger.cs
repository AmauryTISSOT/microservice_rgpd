...
/// <c>Ledger</c> survit au <c>Case</c> de cinq ans.
/// </para>
/// <para>
/// ⚠️ La seule suppression qui existera jamais est celle d'un <c>Ledger</c> <b>entier</b>, échu
...
public interface ILedger
{
  ...
  Task AppendAsync(LedgerEntry entry, CancellationToken cancellationToken = default);
}
